...
namespace ESPP
{
    ...
    void led_thread_run(void *args)
    {
        ...
        ESPP::gpio_pin led(sys->pin, GPIO_MODE_OUTPUT,
                           ESPP::gpio_level_e::GPIO_LEVEL_HIGH);
...
extern "C"
{
    ...
    void app_main()
    {
        ...
        ESPP::inky_eeprom_sys_t eeprom = {.scl = INKY_EEPROM_I2C_SCL,
        ...
        ESPP::led_thread_sys_t ext_led = {
            .delay_ms = 50u, .pin = gpio_num_t::GPIO_NUM_16, .handle = NULL};

        xTaskCreate(ESPP::led_thread_run, "LED_ext", 1024u, (void *)&ext_led, 3u,
                    &ext_led.handle);
