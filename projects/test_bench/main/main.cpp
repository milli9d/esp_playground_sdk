...
void app_main()
{
    ...
    espp::led_thread_sys_t int_led = { .delay_ms = 100u, .pin = gpio_num_t::GPIO_NUM_0, .handle = NULL };
    xTaskCreate(espp::led_thread_run, "LED", 1024, (void*)&int_led, 2u, &int_led.handle);

    espp::led_thread_sys_t ext_led = { .delay_ms = 50u, .pin = gpio_num_t::GPIO_NUM_16, .handle = NULL };
